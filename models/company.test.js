...
describe("findAll", function () {
  ...
  test("works: filter name, minEmployees, and maxEmployees", async function () {
    let companies = await Company.findAll({
      nameLike: 'c',
      minEmployees: '2',
      maxEmployees: '3'
  ...
  test("does not work: where minEmployees > maxEmployees", async function () {
    try {
      let companies = await Company.findAll({
        minEmployees: '2',
        maxEmployees: '1'
      ...
      expect(err instanceof BadRequestError).toBeTruthy();
      expect(err.message).toEqual("Minimum employees cannot exceed maximum employees");
    }
  });
